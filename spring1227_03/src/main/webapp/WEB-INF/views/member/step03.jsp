				...
				<div id="member">
					...
					<div class="memberbd">
						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
								...
								<script>
									$(function(){
										...
										$(".sbtnMini").click(()=>{
											//alert("정규표현식 확인");
											//alert($("#id").val());
											//let idPtn = /^[a-z]{1}[a-zA-Z0-9]{3,15}$/;
											//[] 안에 내가 원하는 문자를 넣으면 있는지 확인
											//{}는 자리수를 의미함
											//let idpattern = /^[a-zA-Z0-9_]{3,10}$/; //3자리이상 10자리까지,특수문자는(_)만사용
											let idpattern = /^[a-z]{1}[a-zA-Z0-9_]{3,15}$/; //첫문자는 영소문자로 시작해서 4자리이상 16자리까지,특수문자는(_)만사용 
											let pwpattern = /^(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_+]).{3,10}$/;
											let tel2pattern = /^[0-9]{3,4}$/; //전화번호 0-9까지 3자리부터4자리까지
											let tel3pattern = /^[0-9]{4}$/; //전화번호 0-9까지 4자리까지
											let namepattern = /^[ㄱ-ㅎ가-힣]$/;
											
											let id = $("#id").val();
											let pw = $("#pw").val();
											if(!idpattern.test(id)){
												alert("첫문자는 영소문자로 시작해서 3자리이상 10자리까지,특수문자는(_)만사용");
												return false;
											}
											...
											//email input value값
											$("#phone").val($("#num_1").val()+"-"+$("#num_2").val()+"-"+$("#num_3").val());
											...
											if(chkCount<1){
												alert("취미를 하나라도 체크해야 다음으로 진행됩니다.");
												return false;
											}
											...
											$.ajax({
												...
												success:function(data){
													...
													if(data=="사용가능"){
														...
														$(".idCheck").css({"color":"blue","font-weight":"700"});
														
													}else{
														alert("아이디 사용 불가능");
														$(".idCheck").text("아이디 사용불가능");
														$(".idCheck").css({"color":"red","font-weight":"700"});
													}
										...
										$("#pw2").keyup(function(){
											if($("#pw").val() != $("#pw2").val()){
												...
												$("#pw_chk").addClass("textOff");
												$("#pw_chk").removeClass("textOn");
											}else{
												$("#pw_chk").text("비밀번호가 일치합니다.");
												$("#pw_chk").addClass("textOn");
												$("#pw_chk").removeClass("textOff");
											}
							...
							<tbody>
							<form name="frm" method="post" action="/member/step04">
								<tr>
									<th scope="row"><span>이름 *</span></th>
									<td>
										<li class="r10"><input type="text" class="w134" name="name" id="name"/></li>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5"><span class="mvalign">첫 글자는 영문으로 4~16자 까지 가능, 영문, 숫자와 특수기호(_)만 사용 가능</span>
											<li class="pt5"><span class="idCheck" >* 아이디 중복확인</span>
											</li>
										</ul>
									</td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><span class="mvalign" id="mvalign">※ 영문 / 숫자 혼용으로 4~20자 까지 가능.</span></li>
										</ul>
									</td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>
												...
												<span class="mvalign orange" id="pw_chk">* 비밀번호 확인</span>
											</li>
										</ul>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><a class="addressBtn cpointer"><span>우편번호 찾기</span></a></li>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								<li><a class="nbtnbig cpointer">취소하기</a></li>
								<li><a class="sbtnMini cpointer">가입하기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
