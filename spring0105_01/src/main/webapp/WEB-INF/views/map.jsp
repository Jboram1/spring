...
<!DOCTYPE html>
	...
	<head>
		...
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=55b3927c5be8914f05f1104ea401f598"></script>
		...
		<style>
			*{margin:0; padding:0;}
			...
			.overlaybox .first {position:relative;width:247px;height:136px;background: url('https://pds.joongang.co.kr/news/component/htmlphoto_mmdata/202401/01/75078957-9665-4c3b-b320-060e3913286d.jpg') no-repeat;margin-bottom:8px;}
