				...
				<div id="customer">
					...
					<script>
						...
						$(function(){
							...
							$(".replyBtn").click(function(){
								...
								$.ajax({
									...
									success:function(data){
										...
										$(".replyBox").prepend(hdata); //상단에 추가 append하단
							...
							$(document).on("click",".delBtn",function(){
								...
								//alert("부모의 부모 id : "+$(this).closest("ul").attr("id")); //가장 근처에 있는 ul을 찾아서 알려달라
							...
							$(document).on("click",".updateBtn",function(){
								...
								//alert("현재 가장 가까운 span 찾기 : "+$(this).parent().parent().find("span").text());
							...
							$(document).on("click",".saveBtn",function(){
								...
								$.ajax({
									...
									dataType:"json", //객체로 보낼땐 꼭 제이슨으로 받아야한다
									success:function(data){
										alert("댓글이 수정되었습니다.");
										console.log(data);
					...
					<div class="replyBox">
						...
						<ul>
							...
							<li class="btn">
								<a class="rebtn saveBtn" style="cursor:pointer;">수정</a>
								<a class="rebtn cancelBtn" style="cursor:pointer;">삭제</a>
							</li>
						</ul>
						 -->
						<!-- 수정 끝 -->
