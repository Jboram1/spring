				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								<p class="txt">작성일<span>${map.bdto.bdate}</span></p>
							</div>
						</div>
...
${map.bdto.bcontent}
						...
						<div class="viewContents"><img style="width:100%;" src="/upload/${map.bdto.bfile}">
						</div>
					</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td><a href="notice_view?bno=${map.prebdto.bno}">${map.prebdto.btitle}</a></td>
								</tr>

								<tr>
									<th class="next">NEXT</th>
									<td><a href="notice_view?bno=${map.nextbdto.bno}">${map.nextbdto.btitle}</a></td>
								</tr>
							</tbody>
						</table>
					</div>
