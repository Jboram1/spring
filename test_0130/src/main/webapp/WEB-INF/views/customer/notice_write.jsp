		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="mypage">
					...
					<div class="checkDivTab2">
						<form action="notice_write" method="post" name="bfrm" id="bfrm" enctype="multipart/form-data">
						<table summary="분류, 구매여부, 작은이미지, 평가, 제목, 상세 내용 순으로 포토 구매후기를 작성 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" class="wlong" name="id" id="id" value="aaa"/>
									</td>
								</tr>
								<tr>
									<th scope="row"><span>제목</span></th>
									<td>
										<input type="text" class="wlong" name="btitle" id="btitle" />
									</td>
								</tr>
								<tr>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								...
								<li><a class="sbtnMini" onclick="sbtn()">확인</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
